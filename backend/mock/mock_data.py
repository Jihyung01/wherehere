...
ROLE_CATEGORY_MAP = {
    ...
    "artist": ["갤러리", "전시관", "카페", "공원", "뷰맛집"],
    "foodie": ["맛집", "카페", "이색장소", "뷰맛집"],
    "challenger": ["러닝코스", "헬스장", "챌린지스팟", "액티비티", "이색장소"],
...
ROLE_NARRATIVES = {
    ...
    "artist": [
        "빛이 만드는 그림자 속에서, 당신만의 순간을 포착하세요.",
        "영감은 길 위에 있습니다. 오늘 이 장소가 당신의 캔버스가 됩니다.",
        "아름다움은 찾는 눈에만 보입니다. 오늘, 당신의 컬렉션에 한 장면을.",
        "시간이 쌓아올린 질감 위에서, 감각이 깨어납니다.",
    ],
    "foodie": [
        "한 입이 만드는 기억. 오늘의 맛이 내일의 그리움이 됩니다.",
        "테이블 위의 요리보다, 그 순간의 분위기가 더 오래 남습니다.",
        "맛은 여행의 목적지. 오늘 이곳이 당신의 스탬프가 됩니다.",
        "새로운 맛은 새로운 경험. 한 끼가 이야기가 됩니다.",
    ],
    "challenger": [
        "한 걸음이 쌓여 기록이 되고, 기록이 쌓여 전설이 됩니다.",
        "어제의 한계가 오늘의 출발선. 매일이 새로운 도전입니다.",
        "이 장소가 오늘의 스테이지. 한계를 넘어서 보세요.",

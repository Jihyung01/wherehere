-- ============================================================
-- WhereHere Initial Schema Migration (Fixed)
-- Created: 2026-02-10
...
CREATE TABLE public.users (
    ...
    -- Role System (quoted to avoid reserved word conflict)
    user_role VARCHAR(20) NOT NULL DEFAULT 'explorer' 
        CHECK (user_role IN ('explorer', 'healer', 'archivist', 'relation', 'achiever')),

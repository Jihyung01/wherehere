-- ============================================================
-- WhereHere 완전 새로 시작 (기존 테이블 삭제 후 재생성)
-- ============================================================
...
CREATE INDEX idx_user_visits_user ON user_visits(user_id, visited_at DESC);
CREATE INDEX idx_user_visits_place ON user_visits(place_id);
